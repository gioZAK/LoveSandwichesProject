...
def update_sales_worksheet(data):
    """
    Update sales worksheet, adds a new role with the list data provided.
    """
...
def update_surplus_worksheet(new_surplus_data):
    """
    Update surplus worksheet, adds a new with the calculated surplus data.
    """
...
def calculate_surplus_data(sales_row):
    ...
    - Negative surplus indicates extra items made when stock was sold out.
    """
